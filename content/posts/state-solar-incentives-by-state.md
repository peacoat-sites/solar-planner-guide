...
## Net Metering: The Ongoing Incentive Most People Underestimate

Net metering deserves its own discussion because it's not a one-time discount. It's an ongoing cash flow mechanism that affects your return every single month for the life of your system.

Under full retail net metering (the most favorable version), your utility credits you at the full retail electricity rate for every excess kilowatt-hour you send to the grid. If you pay $0.18/kWh for power you consume, you also receive $0.18/kWh credit for power you export. That symmetry maximizes your savings.

Some states have moved to "avoided cost" net metering, where exports are credited at the wholesale rate, often $0.03 to $0.06/kWh. That dramatically changes your payback timeline. If you're exporting 40% of your production and only getting credited at a third of the retail rate, your effective system value drops substantially. You can dig into how these structures affect your monthly bill on our [net metering savings explained page](/net-metering-savings-explained/).

States with strong net metering protection include Massachusetts, Rhode Island, Vermont, New Hampshire, Maryland, and Illinois. States where net metering has been weakened or is under active threat include California (already changed), Arizona, Nevada (partially reversed after a solar-unfriendly change in 2015), and Florida.

If you're in a state with uncertain net metering, right-sizing your system to match your consumption rather than overbuilding for export becomes more important. You don't want to produce power that earns you almost nothing.

## A State-by-State Incentive Snapshot (Key Programs)

| State | State Tax Credit | Rebate Program | Sales Tax Exempt | Property Tax Exempt | Net Metering Strength |
|---|---|---|---|---|---|
| Massachusetts | 15% (up to $1,000) | SMART production tariff | Yes | Yes | Strong |
| New York | 25% (up to $5,000) | NY-Sun per-watt rebate | Yes | Yes | Strong |
| New Jersey | None | SREC market | Yes | Yes | Moderate-Strong |
| California | None | Some utility rebates | No | Yes | Weakened (NEM 3.0) |
| Texas | None | Utility rebates vary | Yes | Yes (100%) | Moderate |
| Florida | None | None statewide | Yes | Yes | Contested |
| Arizona | 25% (up to $1,000) | None | Yes | Yes | Weakened |
| Colorado | None | Xcel Energy rebates | Yes | Yes | Moderate |
| Illinois | None | Illinois Shines SREC | Yes | Yes | Strong |
| Georgia | None | None | No | No statewide | Weak |

This table reflects general program status as of 2025. Always verify current rates with your state energy office because programs adjust funding caps regularly.

## How to Actually Find and Stack Your State's Incentives

Here's a practical process I recommend to every client before they get their first installer quote.

**Step 1: Start at the Database of State Incentives for Renewables and Efficiency (DSIRE) at dsireusa.org.** Enter your zip code and filter for solar. You'll see every state, utility, and local incentive available. Don't skip utility programs. Some of the best rebates come from utilities, not the state.

**Step 2: Calculate your federal credit first.** Your 30% ITC is calculated on the full system cost before any other rebates reduce the price. In most cases, utility rebates don't reduce your ITC basis, but state tax credits might depending on how they're structured. This distinction can affect your credit amount by hundreds or thousands of dollars. Our [ITC solar investment tax credit explanation](/itc-solar-investment-tax-credit-explained/) walks through how the credit applies to different system cost scenarios.

**Step 3: Identify whether your state has a production incentive (like SMART or an SREC market) versus a one-time rebate.** Production incentives pay out over years and can be more valuable in the long run, but they require paperwork and registration with your utility or state program.

**Step 4: Confirm your utility's current net metering rate and structure.** Call the utility directly or check their rate tariff filed with the state public utility commission. Don't take an installer's word for it.

**Step 5: Get at least three quotes and ask each installer to itemize which incentives they've included in their savings projections.** EnergySage's market data shows that homeowners who compare multiple quotes save an average of 20% on system cost. That matters as much as any state rebate.
