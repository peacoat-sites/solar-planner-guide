...
2. **Check production monthly**, not just when your bill looks odd. Most inverter apps show daily and monthly totals.
3. **Compare year over year.** A 0.5% dip per year is expected. A 5% drop in a single year signals a problem.
4. **Install a whole-home energy monitor** if your utility doesn't provide real-time data. Devices like the [Emporia Vue Energy Monitor](https://www.amazon.com/s?k=emporia+vue+energy+monitor) give you circuit-level visibility and can help you see if your solar export is dropping unexpectedly.
...
- **[Emporia Vue 2 Home Energy Monitor](https://www.amazon.com/dp/B09ZJ1WVGK?tag=contentportfo-20)**, Circuit-level visibility of your entire home's electricity use and solar production, works with most homes.
