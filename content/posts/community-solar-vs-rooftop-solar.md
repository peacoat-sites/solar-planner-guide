...
faqs:
  - q: "Can renters access community solar?"
    a: "Yes, and this is genuinely one of its best use cases. Most community solar subscriptions require nothing more than a utility account in the service territory where the solar farm operates. You don't need to own property, have a suitable roof, or make any capital investment."
  - q: "Does community solar actually save money?"
    a: "Modestly, yes. Most subscribers see 5-15% discounts on the portion of electricity covered by their subscription. In dollar terms, that's typically $50-$200 per year for an average household. It's real savings, but don't go in expecting a dramatic reduction on your bill."
  - q: "Is rooftop solar worth it if I might move in five years?"
    a: "It depends on your market. In states with strong solar home value premiums (California, Massachusetts, Colorado), a well-sized system often sells with the house at close to its residual value. In markets with lower solar adoption or weaker net metering, you may not recoup your investment. Run the math for your specific state before assuming it's a wash."
...
Not everyone. I'll say that plainly because installers won't.

Rooftop solar has a strong financial case when you own your home, have a south or west-facing roof with minimal shading, use a meaningful amount of electricity (think $150+ monthly bills), and plan to stay put for at least seven to ten years. The [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/) has published research showing that only about half of U.S. residential rooftops are even technically suitable for solar, when you factor in orientation, shading, and structural issues.
...
This is where I'd argue most coverage buries the lead. Community solar has expanded dramatically, and as of July 2026, it's available in roughly 20 states plus D.C. The [Solar Energy Industries Association (SEIA)](https://www.seia.org/) tracks this market closely, and the growth has been real: the community solar sector now serves millions of subscribers who couldn't access rooftop solar at all.
...
If you're curious about monitoring your home energy use before deciding anything, a device like the [Emporia Vue Energy Monitor](https://www.amazon.com/s?k=emporia+vue+energy+monitor) (under $100, widely used) will give you a granular picture of your actual consumption patterns. *(Note: this site may earn a commission on purchases.)* Knowing whether you consume heavily in the morning or evening matters for both net metering math and time-of-use rate analysis.

## Sources

- [NREL Rooftop Solar Technical Potential](https://www.nrel.gov/): Research on the percentage of U.S. rooftops technically suitable for solar installation.
- [SEIA Community Solar](https://www.seia.org/): Industry data on community solar capacity, subscriber counts, and state availability.
- [EnergySage Solar Marketplace Data](https://www.energysage.com/): Installer pricing benchmarks and consumer quote data for residential rooftop systems.
- [Lawrence Berkeley National Laboratory "Tracking the Sun"](https://emp.lbl.gov/tracking-the-sun): Annual report on residential solar system costs, sizing, and trends.
- [Zillow Research on Solar Home Value](https://www.zillow.com/research/): Analysis of solar's impact on residential property values.
