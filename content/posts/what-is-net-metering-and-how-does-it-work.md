...
The [U.S. Department of Energy's homeowner solar guide](https://www.energy.gov/eere/solar/homeowners-guide-going-solar) has a solid breakdown of what to look for in your utility's tariff. Worth 20 minutes before you sign anything.
...
Most modern inverters include monitoring apps (SolarEdge, Enphase, SMA, Fronius all have solid platforms), but they typically show production data only. To see actual net usage and grid interaction, you want a whole-home energy monitor at your breaker panel. The [Emporia Vue 2](https://www.amazon.com/s?k=Emporia+Vue+2+energy+monitor) runs around $80 to $120 and gives circuit-level data that's genuinely useful for shifting loads to match your production curve, which matters far more in avoided-cost net metering markets.
