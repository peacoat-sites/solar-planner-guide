...
faqs:
 ...
 - q: "Should I trust the savings estimate my solar installer gives me?"
...
| Calculator | Uses Real Roof Data | Adjustable Assumptions | Net Metering Accuracy | Best For |
|---|---|---|---|---|
| Google Project Sunroof | Yes (aerial imagery) | Limited | Basic | Quick visual check |
| EnergySage Calculator | Partial | Yes | Good | Getting quotes, comparing |
| PVWatts (NREL) | No (manual input) | Extensive | No | Verifying installer estimates |
| Utility's Own Tool | No | Limited | Excellent | Rate and policy accuracy |
| Installer-Provided | Varies | Often locked | Varies | Treat with skepticism |
