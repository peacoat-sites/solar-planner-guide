...
faqs:
  - q: "What credit score do I need to qualify for a solar loan?"
    a: "Most unsecured solar loan products require a minimum score of 620 to 650, though the best rates typically go to borrowers with scores of 700 or above. HELOC products from banks often require 680 or higher. PACE financing has no credit score requirement, though it comes with the lien risks described above."
  - q: "Should I wait to go solar until I can pay cash?"
    a: "Not necessarily. If your electricity bill is high and rates are rising, every month you wait is money you're paying to the utility. A well-structured solar loan with a monthly payment below your current electricity bill means you're saving from day one. The goal isn't to pay cash -- it's to make the math work in your favor."
  - q: "Can I use a home equity line of credit for solar?"
    a: "Yes, and it's often one of the better options available. HELOCs typically carry lower rates than unsecured solar loans, and the interest may be tax-deductible depending on how you use the funds. The variable rate is the main risk in a rising rate environment, so a fixed home equity loan is worth comparing if your lender offers it."
  - q: "Does the federal tax credit work if I'm financing?"
...
|---|---|---|---|
| Upfront cost | Full price | $0 to low | $0 |
| Who owns the system | You | You | Installer |
| Federal tax credit | You keep it | You keep it | Installer keeps it |
