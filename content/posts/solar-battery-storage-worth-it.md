...
faqs:
  - q: "Does a solar battery qualify for the 30% federal tax credit?"
    a: "Yes. Since the Inflation Reduction Act took effect, standalone battery storage systems (not just batteries paired with solar) qualify for the 30% Investment Tax Credit. The battery must have a capacity of at least 3 kWh, which all major residential systems exceed. This credit applies to the full installed cost, including labor. Consult a tax professional to confirm eligibility for your specific situation."
  - q: "How long do home solar batteries actually last?"
    a: "Most major batteries, including the Tesla Powerwall and Enphase IQ systems, carry a 10-year warranty. Real-world longevity depends heavily on daily cycle depth and operating temperature. NREL research suggests lithium iron phosphate (LFP) chemistry batteries, which includes Powerwall 3, handle deep daily cycling better than older NMC chemistry batteries. With proper management, 12 to 15 years of useful service is realistic, though capacity will degrade over time."
  - q: "Can I add a battery to existing solar panels I already have installed?"
    a: "Yes, in most cases. This is called AC coupling. Your existing solar inverter continues to operate, and a new hybrid or storage inverter is added to manage the battery. It works but is slightly less efficient than a DC-coupled system where the battery and panels share a single inverter. The added equipment cost and potential efficiency loss (roughly 5 to 10%) are worth factoring into your savings projections."
  - q: "Will a solar battery power my whole house during an outage?"
...
| Scenario | Battery Likely Worth It? | Key Reason |
|---|---|---|
| High TOU rates ($0.40+ peak), low net metering credit | Yes | Strong arbitrage value |
| Flat rate utility, full net metering | Probably not (financial basis) | Payback likely 15+ years |
| Frequent outages, critical medical equipment | Yes | Quantifiable backup value |
| California NEM 3.0 customer | Strong yes | Export credits gutted |
| Rural co-op, $0.12/kWh flat rate | No | Math doesn't work |
| Hurricane/wildfire zone, no generator | Yes | Resilience value real |
...
Also, if you're considering a [solar charge controller](https://www.amazon.com/s?k=solar+charge+controller) *(Amazon affiliate link)* for a smaller off-grid or supplemental setup, know that these only apply to DC-coupled systems, which is different from the AC-coupled architecture most whole-home battery installations use.
...
Yes. Since the Inflation Reduction Act took effect, standalone battery storage systems (not just batteries paired with solar) qualify for the 30% Investment Tax Credit. The battery must have a capacity of at least 3 kWh, which all major residential systems exceed. This credit applies to the full installed cost, including labor. Consult a tax professional to confirm eligibility for your specific situation.

### How long do home solar batteries actually last?

Most major batteries, including the Tesla Powerwall and Enphase IQ systems, carry a 10-year warranty. Real-world longevity depends heavily on daily cycle depth and operating temperature. NREL research suggests lithium iron phosphate (LFP) chemistry batteries, which includes Powerwall 3, handle deep daily cycling better than older NMC chemistry batteries. With proper management, 12 to 15 years of useful service is realistic, though capacity will degrade over time.

### Can I add a battery to existing solar panels I already have installed?

Yes, in most cases. This is called AC coupling. Your existing solar inverter continues to operate, and a new hybrid or storage inverter is added to manage the battery. It works but is slightly less efficient than a DC-coupled system where the battery and panels share a single inverter. The added equipment cost and potential efficiency loss (roughly 5 to 10%) are worth factoring into your savings projections.

### Will a solar battery power my whole house during an outage?

Rarely, at full normal usage. A single 13.5 kWh battery might cover your essential loads (refrigerator, lights, phone charging, internet) for 18 to 24 hours if you're careful. Running central air conditioning, electric water heaters, or an electric range dramatically cuts that window. Most battery owners designate a "backup circuits" panel that prioritizes critical loads rather than trying to run everything.

### What's the research say about the best battery brands right now?

The research here is genuinely mixed, partly because this market is moving fast. Tesla Powerwall has the largest installed base and most third-party performance data. Enphase IQ is modular and works especially well with Enphase microinverter systems. Franklin Electric's WH10 has been gaining installer confidence. SunPower's SunVault is well-regarded but SunPower's 2024 bankruptcy created uncertainty about long-term support. I'd weight installer track record with a specific battery heavily, since local service quality matters as much as product specs.
