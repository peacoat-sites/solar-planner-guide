...
faqs:
  - q: "Does the federal solar tax credit expire in 2024 or 2025?"
    a: "No. The 30% rate is fully in effect through 2032 for residential installations. After 2032, it steps down to 26% in 2033, then 22% in 2034, then expires for residential in 2035. Confusion about earlier dates often comes from pre-IRA timelines, when the credit was scheduled to drop much sooner. The Inflation Reduction Act extended and locked in the 30% rate for the rest of the decade."
  - q: "What if my solar system is installed in December 2032 but the utility doesn't approve the interconnection until January 2033?"
    a: "This is a real risk. The IRS requires your system to be 'placed in service' to claim the credit for that tax year, and placed in service generally means connected to the grid. If your utility drags its feet and you don't get Permission to Operate until January, you'd claim the 26% credit for 2033 instead of 30% for 2032. This is exactly why waiting until the last possible moment is a bad strategy."
  - q: "Can I claim the credit if I financed my solar installation with a loan?"
    a: "Yes. As long as you own the system (not a lease or PPA), you qualify for the ITC regardless of how you paid for it. This includes solar loans, personal loans, home equity lines, or cash. The credit is based on the total installed cost, not how much you've paid out of pocket at the time of filing."
  - q: "Is the 30% credit on top of any state or utility incentives?"
...
| Year | ITC Rate | Notes |
|------|----------|-------|
| 2025 | 30% | Full credit, currently in effect |
| 2026 | 30% | Full credit continues |
| 2027-2032 | 30% | Full credit through end of 2032 |
...
### Does the federal solar tax credit expire in 2024 or 2025?

No. The 30% rate is fully in effect through 2032 for residential installations. After 2032, it steps down to 26% in 2033, then 22% in 2034, then expires for residential in 2035. Confusion about earlier dates often comes from pre-IRA timelines, when the credit was scheduled to drop much sooner. The Inflation Reduction Act extended and locked in the 30% rate for the rest of the decade.

### What if my solar system is installed in December 2032 but the utility doesn't approve the interconnection until January 2033?

This is a real risk. The IRS requires your system to be "placed in service" to claim the credit for that tax year, and placed in service generally means connected to the grid. If your utility drags its feet and you don't get Permission to Operate until January, you'd claim the 26% credit for 2033 instead of 30% for 2032. This is exactly why waiting until the last possible moment is a bad strategy.

### Can I claim the credit if I financed my solar installation with a loan?

Yes. As long as you own the system (not a lease or PPA), you qualify for the ITC regardless of how you paid for it. This includes solar loans, personal loans, home equity lines, or cash. The credit is based on the total installed cost, not how much you've paid out of pocket at the time of filing.

### Is the 30% credit on top of any state or utility incentives?

Yes and no. The federal ITC is calculated on your gross system cost before most state incentives, but there's an exception: if you receive a state rebate that's excluded from your gross income, it doesn't reduce your ITC basis. Utility rebates, though, typically do reduce the cost basis you use to calculate the federal credit. The interaction can get complicated, so it's worth running the numbers for your specific state.

### What happens to my tax credit if I sell my house after going solar?
