...
faqs:
  - q: "Is a ground-mount solar system more expensive than a rooftop system?"
    a: "Yes, typically by $2,500 to $5,000 on an average residential system, or roughly $0.25 to $0.50 per watt more. That premium can be worth it if your roof is shaded, poorly oriented, or nearing the end of its life, but on a well-sited roof, rooftop systems usually offer faster payback due to lower upfront costs."
  - q: "Do ground-mounted solar panels produce more electricity than roof panels?"
    a: "They can, but it depends entirely on your specific roof. If your roof has shading issues, wrong orientation, or forces a suboptimal tilt, a ground mount optimized for your location will outperform it. If your roof is already well-oriented and shade-free, you probably won't see a meaningful production difference."
  - q: "Will a ground mount affect my property value?"
    a: "The research here is honestly thinner than I'd like. Rooftop solar has solid data behind it (a 2019 Zillow analysis found rooftop systems added roughly 4% to home value), but ground mounts have less documented resale impact. Some buyers see them as a feature; others are put off by the yard space they consume. I'd treat any property value gain as a bonus, not a core part of your financial case."
  - q: "Do I need a permit for a ground-mounted solar system?"
...
- [EnergySage Solar Marketplace Report](https://news.energysage.com/): Current pricing data on residential rooftop vs. ground-mount installations, installer quotes, and cost-per-watt benchmarks across U.S. markets.
- [NREL PVWatts Calculator](https://pvwatts.nrel.gov/): NREL's tool for estimating residential solar energy production based on tilt, azimuth, location, and shading inputs.
- [U.S. Department of Energy, Homeowner's Guide to Going Solar](https://www.energy.gov/eere/solar/homeowners-guide-going-solar): Federal resource covering system types, incentives, installer selection, and technology options for residential buyers.
- [SEIA U.S. Solar Market Insight](https://www.seia.org/research-resources/us-solar-market-insight): Industry data on residential installation trends and market growth, current as of 2026.
- [Solar Energy Technologies Office, Shading and Soiling Research](https://www.energy.gov/eere/solar): NREL and DOE analysis on production losses from shading and site orientation, used to validate production modeling estimates.
