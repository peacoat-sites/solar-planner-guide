---
title: "Solar Sales Tax Exemption: Save on Your Installation"
date: 2026-07-15T16:15:47.964437+00:00
draft: false
description: "Learn how solar sales tax exemptions work, which states offer them, and how to claim tax breaks when installing solar panels."
image: "/img/heroes/9875405.jpg"
categories: ["Tax Credits & Incentives"]
tags: ["solar", "sales", "exemption"]
author: "Derek Hansen"
...
faqs:
  - q: "Does the solar sales tax exemption apply to battery storage?"
    a: "It depends on the state. As of 2026, states like New Jersey and Massachusetts include battery storage in their solar exemptions. Others, like Texas, have narrower definitions that may or may not cover standalone batteries. If you're adding a battery like a Tesla Powerwall or Enphase IQ Battery, confirm specifically whether it qualifies before assuming."
  - q: "Is the exemption automatic, or do I have to apply for it?"
    a: "Usually automatic at the point of sale. Your installer should simply not charge you sales tax on exempt equipment. However, in some states (North Carolina, Massachusetts), a certificate or form may be required. Ask your installer to confirm the process before signing, and request an itemized invoice showing $0 in sales tax on qualifying equipment."
  - q: "Can I get the exemption on a solar lease or PPA?"
    a: "Typically no. If you lease the system or sign a power purchase agreement, the solar company owns the equipment, not you. The exemption, where it exists, usually applies to the buyer of the equipment. This is one of several financial reasons I generally prefer purchase or solar loan structures for homeowners who can qualify."
  - q: "What if my installer charged me sales tax in a state with an exemption?"
    a: "It happens. You have a few options: ask the installer to correct the invoice and refund the tax (they can file an amended return with the state), or contact your state's department of revenue directly and ask about filing for a refund yourself. Keep your original invoice and contract as documentation. The window for these refunds varies by state, typically one to three years."
  - q: "Does the sales tax exemption affect my federal ITC calculation?"
    a: "Slightly, yes. The ITC is calculated on your net system cost including sales tax paid. If an exemption reduces your sales tax to zero, your ITC base is modestly lower. But as the table above shows, the upfront savings from the exemption almost always outweigh the marginal reduction in your ITC value. You come out ahead by having the exemption."
---

Thirty-one states have a solar sales tax exemption on the books right now. [Most homeowners](/the-july-4-solar-deadline-most-homeowners-have-never-heard-of/) going solar have no idea, and more than a few installers don't volunteer the information either. That's a problem, because on a $25,000 system, a 6% state sales tax is $1,500 walking out your door for no reason.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">31 states currently offer full or partial sales tax exemptions on residential solar equipment.</li><li style="margin:5px 0">On a $25,000 system, a 6% exemption saves roughly $1,500 at point of sale, no filing required.</li><li style="margin:5px 0">Exemptions typically apply to equipment (panels, inverters, batteries), not labor, verify with your installer.</li><li style="margin:5px 0">Some states require the homeowner to submit a form to claim the exemption; it's not always automatic.</li><li style="margin:5px 0">The federal ITC and state sales tax exemptions stack, you can claim both.</li></ul></div>
...
As of July 2026, 31 states offer some form of solar sales tax exemption for residential systems. The specifics vary considerably. Some states exempt 100% of solar equipment sales tax. Others cap the exemption at a dollar amount or tie it to [system size](/solaredge-nexis-just-hit-the-us-what-it-means-for-your-system-size/).


<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated sales tax savings on a $25,000 solar system by state rate</div><div class="sc-row"><span class="sc-label">Arizona (5.6%)</span><span class="sc-track"><span class="sc-bar" style="width:81%"></span></span><span class="sc-val">$1,400</span></div><div class="sc-row"><span class="sc-label">New Jersey (6.625%)</span><span class="sc-track"><span class="sc-bar" style="width:96%"></span></span><span class="sc-val">$1,656</span></div><div class="sc-row"><span class="sc-label">Texas (6.25%)</span><span class="sc-track"><span class="sc-bar" style="width:91%"></span></span><span class="sc-val">$1,563</span></div><div class="sc-row"><span class="sc-label">North Carolina (4.75%)</span><span class="sc-track"><span class="sc-bar" style="width:69%"></span></span><span class="sc-val">$1,188</span></div><div class="sc-row"><span class="sc-label">Massachusetts (6.25%)</span><span class="sc-track"><span class="sc-bar" style="width:91%"></span></span><span class="sc-val">$1,563</span></div><div class="sc-row"><span class="sc-label">Florida (6.0%)</span><span class="sc-track"><span class="sc-bar" style="width:87%"></span></span><span class="sc-val">$1,500</span></div><div class="sc-row"><span class="sc-label">Minnesota (6.875%)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$1,719</span></div><div class="sc-src">Source: State revenue codes, SEIA 2026</div></div>
...
As of July 2026, roughly 36 states have some form of property tax exemption for solar installations. The [U.S. Department of Energy](https://www.energy.gov/eere/solar/homeowners-guide-going-solar) maintains a database of state and local incentives (DSIRE) where you can look up both types by ZIP code. Bookmark it. It's the most reliable single source for what's available where you live.
...
- [SEIA State Solar Policy](https://www.seia.org/state-solar-policy): Solar Energy Industries Association tracking of state-by-state solar incentives and legislation.
- [DSIRE Database (NC Clean Energy Technology Center)](https://www.dsireusa.org/): Comprehensive database of state and local solar incentives, updated regularly.
- [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/): Research on installed solar costs, incentive stacking, and market trends.
- [U.S. Department of Energy, Homeowner's Guide to Going Solar](https://www.energy.gov/eere/solar/homeowners-guide-going-solar): Federal resource covering ITC, state incentives, and financing options.
- North Carolina Department of Revenue, Form E-599C: State certificate of exemption for solar and energy equipment purchases.
