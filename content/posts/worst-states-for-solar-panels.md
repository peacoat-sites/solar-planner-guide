---
title: "Worst States for Solar Panels: Where Installation Doesn't Pay"
date: 2026-07-14T09:18:11.059906+00:00
draft: false
description: "Discover which states have the least favorable conditions for solar panel installation, including cloud cover, costs, and incentive challenges."
image: "/img/heroes/37341527.jpg"
categories: ["State Solar Guides"]
tags: ["worst", "states", "solar", "panels"]
...
slug: "worst-states-for-solar-panels"
affiliate_disclosure: true
faqs:
  - q: "Is Louisiana really the worst state for solar?"
    a: "It's consistently near the bottom of financial return rankings, mostly because electricity rates are so low (around $0.09 to $0.10/kWh) and net metering policy has historically undervalued exported energy. It's not the worst for sunshine, just for the economics."
  - q: "Does the 30% federal tax credit change the math in these states?"
    a: "It helps, but it doesn't fix the underlying problem. The federal Residential Clean Energy Credit (currently 30% as of 2026) reduces upfront cost, but if your electricity rate is $0.09/kWh and you're exporting at $0.035/kWh, the savings per year are still modest. A shorter payback becomes a slightly shorter payback."
  - q: "What about battery storage in bad solar states?"
    a: "Batteries like the Tesla Powerwall 3 or Enphase IQ Battery can partially compensate for poor net metering by letting you store and use your own power instead of exporting it cheaply. They add $8,000 to $15,000 to a system cost, though, and extend payback periods unless your state has a storage incentive."
  - q: "Can I tell upfront if net metering in my state is good or bad?"
    a: "Yes. Check SEIA's state solar policy page, and ask your utility directly what the 'export compensation rate' is per kWh. If it's the same as your retail rate, that's full net metering. If it's listed as 'avoided cost' or something lower, expect a longer payback."
  - q: "Are there any states where solar is truly a bad financial decision for most homeowners?"
    a: "Honestly, yes. For homeowners with small electricity bills (under $80 to $90/month), average or low sun hours, and no strong state incentive, states like North Dakota, Wyoming, and Louisiana can produce payback periods that approach or exceed the system's useful life. That's a situation where I'd tell someone to wait, or to focus on efficiency upgrades first."
---
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated solar payback period by state (years)</div><div class="sc-row"><span class="sc-label">Louisiana</span><span class="sc-track"><span class="sc-bar" style="width:95%"></span></span><span class="sc-val">19 years</span></div><div class="sc-row"><span class="sc-label">Idaho</span><span class="sc-track"><span class="sc-bar" style="width:90%"></span></span><span class="sc-val">18 years</span></div><div class="sc-row"><span class="sc-label">Michigan</span><span class="sc-track"><span class="sc-bar" style="width:70%"></span></span><span class="sc-val">14 years</span></div><div class="sc-row"><span class="sc-label">Indiana</span><span class="sc-track"><span class="sc-bar" style="width:80%"></span></span><span class="sc-val">16 years</span></div><div class="sc-row"><span class="sc-label">North Dakota</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">20 years</span></div><div class="sc-row"><span class="sc-label">Arizona</span><span class="sc-track"><span class="sc-bar" style="width:40%"></span></span><span class="sc-val">8 years</span></div><div class="sc-src">Source: EnergySage, NREL, state utility data, 2026 estimates</div></div>
...
Net metering is the policy that lets you sell excess solar power back to the grid at or near retail rates. When it's generous, it's the financial backbone of rooftop solar economics. When it's gutted, your system only "pays" you for the hours you're home and consuming the power you're generating. The [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/) has modeled this extensively: moving from full retail net metering to an avoided-cost rate can reduce the value of a solar system by 30 to 50 percent over its lifetime.
...
**Michigan homeowner, zero-export design** → Works with installer to size a 6kW system explicitly for on-site consumption only, monitors closely with a [home energy monitor like the Emporia Vue](https://www.amazon.com/s?k=Emporia+Vue+home+energy+monitor) (the site may earn a commission on purchases like this) to avoid exporting to the grid at low rates → Payback drops to approximately 11 years. Still longer than Arizona or Massachusetts, but workable.

## When a "Bad State" Is Still a Good Decision

I want to be honest: none of this is a flat "don't do it." If you're building a new home in North Dakota and you want energy independence, or if you've got a south-facing roof with no shading and you're financing the system at a low rate, the calculus can still work in your favor. The [U.S. Department of Energy's homeowner solar guide](https://www.energy.gov/eere/solar/homeowners-guide-going-solar) has good baseline tools for estimating production.
...
If you're in one of these states and still want to explore it, get quotes from at least three installers on [EnergySage](https://www.energysage.com/) to see competitive pricing, and ask each one specifically about your utility's net metering rate and the export compensation structure.

## Sources

- [NREL: PVWatts Calculator](https://pvwatts.nrel.gov/): NREL's tool for estimating solar energy production by location, used for peak sun hour data cited here.
- [EnergySage Solar Marketplace](https://www.energysage.com/): Aggregated installer pricing, payback period estimates, and state-by-state comparisons as of 2026.
- [U.S. Department of Energy: Homeowner's Guide to Going Solar](https://www.energy.gov/eere/solar/homeowners-guide-going-solar): Federal resource on solar economics, incentives, and system planning.
- [SEIA: State Solar Policy](https://www.seia.org/state-solar-policy): Solar Energy Industries Association state-by-state policy tracker, including net metering status.
...
*Photo: [Diana Reyes](https://www.pexels.com/@diana-reyes-227887231) via Pexels*