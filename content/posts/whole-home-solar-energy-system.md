...
slug: "whole-home-solar-energy-system"
affiliate_disclosure: true
faqs:
 - q: "How many solar panels does it take to power a whole house?"
   a: "For an average U.S. home using around 10,500 kWh per year, you typically need 20 to 30 panels depending on panel wattage and your location's sun hours. A home in Arizona needs fewer panels than the same-sized home in Michigan. Pull your actual annual kWh from your utility bills and run the numbers through NREL's PVWatts calculator for a site-specific estimate."
 - q: "Can a solar system really power everything, including AC and an electric dryer?"
   a: "Yes, if it's properly sized. The mistake is installing a system based on 'average' usage without accounting for your specific high-draw appliances. An EV charger alone can add 3,000 to 4,000 kWh per year. Tell every installer exactly what appliances you have and plan to add, and make sure they're designing the system around your real load."
 - q: "Do I need battery storage for a whole home solar system?"
   a: "No. Most whole home systems work fine without batteries if you're on a reasonable net metering program. Batteries make financial sense if your utility charges high time-of-use rates, if you have frequent outages, or if your net metering policy is unfavorable. Don't let anyone tell you the system is incomplete without them."
 - q: "How long does a whole home solar installation take?"
...
The [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/) publishes a free tool called PVWatts that lets you input your address and system size and get a realistic annual production estimate. Use it before you talk to any installer. Walk in knowing your numbers.
