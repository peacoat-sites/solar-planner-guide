...
## Why the Solar Market Rewards Shoppers (More Than Almost Any Other Home Purchase)
...
Price per watt is the single most useful number for comparison. Divide the total system cost (before incentives) by the system size in watts. If Installer A is quoting 10,000 watts for $32,000, that's $3.20/watt. If Installer B is quoting the same system for $28,500, that's $2.85/watt. That difference matters, and you can ask Installer A to explain it.
