...
This quick 7-question quiz helps you reflect on those pieces and get a feel for where you stand. It takes about two minutes, there's nothing to sign up for, and it's built purely to help you think it through before you start gathering real quotes.

{{< quiz >}}

However you scored, treat this as a starting point rather than a verdict. Every home is different, and the only way to know your real numbers is a custom estimate from a reputable installer. Browse our beginner guides to learn what to look for, then line up a couple of quotes when you're ready to compare.
