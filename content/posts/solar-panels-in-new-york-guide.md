...
faqs:
  - q: "How long does solar installation take in New York?"
    a: "The physical installation is typically one to two days. What takes time is permitting and utility interconnection approval, which in New York can run 4 to 12 weeks depending on your utility and municipality. Con Edison tends to move slower than some rural utilities. Build that into your timeline."
  - q: "Do solar panels work in winter in New York?"
    a: "Yes, and sometimes better than you'd expect. Solar panels actually perform more efficiently in cold temperatures. You'll produce less in December and January simply because days are shorter, but a properly sized system accounts for this through annual production averaging and net metering credits built up in summer."
  - q: "Is my roof suitable for solar panels?"
    a: "A south-facing roof with minimal shading and at least 15 to 20 years of remaining life is ideal, but plenty of New York homes get good results from east-west split arrays or even north-facing panels at steeper pitches. The NREL's PVWatts calculator lets you input your address and roof orientation to estimate actual production before you ever talk to an installer."
  - q: "What's the payback period for solar in New York?"
...
Start with the federal Investment Tax Credit (ITC). As of 2025, it's 30% of your total system cost, and it comes directly off your federal tax liability. On a $28,000 system (a reasonable midpoint for a 7-8 kW installation in New York), that's $8,400 back. You need to actually owe that much in federal taxes to claim it fully, though it can roll forward if you don't use it all in year one. Worth confirming with a tax professional.

On top of that, New York State offers its own solar tax credit: 25% of system cost up to $5,000. That's almost always the full $5,000 for a typical residential system. Combined with the federal credit, you're looking at $13,400 off a $28,000 system before touching any other programs.

Then there's NY-Sun, the state's solar incentive program run through NYSERDA. It provides upfront incentives per watt of installed capacity, with amounts varying by your utility territory and whether you're on Con Edison, National Grid, NYSEG, or another provider. As of early 2025, the Con Edison territory incentive was around $0.20 per watt for residential systems, adding another $1,400 to $1,600 for a typical installation. Check the [NYSERDA NY-Sun dashboard](https://www.nyserda.ny.gov/) for current rates, because these step down as the program fills up.

Finally, New York exempts solar systems from property tax increases for 15 years under the Solar Energy System Equipment Exemption. Your home value goes up when you install solar (a Lawrence Berkeley Lab study found an average premium of about $15,000), but your property tax assessment won't reflect that addition for a decade and a half. In Westchester or Nassau County, where property taxes are already significant, this is not a trivial benefit.

## Net Metering: Good Right Now, But Pay Attention

New York switched to a modified net metering structure called "Value of Distributed Energy Resources" (VDER) for some customers, and it's been a subject of real debate. Here's the honest version: most residential customers on Con Edison and other major utilities are still grandfathered or newly enrolled under the traditional net metering framework, which credits you at the full retail rate for excess electricity you export to the grid.
...
I want to be honest here, because a lot of solar content is essentially sales material wearing an educational hat.

If your roof is more than 15 years old and will need replacement within 5 years, install the roof first or plan to do both simultaneously. Removing and reinstalling solar panels costs $1,500 to $3,500, and that expense will eat into your payback significantly. I've talked to homeowners who found out about this mid-process and were blindsided.

If you're in a co-op or condo in New York City, your path to rooftop solar is almost certainly community solar, not rooftop panels. About 40% of New York households rent or live in multi-family buildings, and community solar subscriptions (Arcadia, ConEdison Clean Energy, and others) let you subscribe to off-site solar and receive credits on your bill, typically saving 5 to 15% on your electricity costs. Not as dramatic as ownership, but meaningful and easy to access.
...
- [Emporia Solar Monitor](https://www.amazon.com/s?k=solar+energy+monitor)
