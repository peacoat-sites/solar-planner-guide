...
Here's where I have to be honest, because installers almost never are.
...
1. What is your current net metering export rate per kilowatt-hour?
2. Do you have any rebate or incentive programs for residential solar?
3. Are there battery storage incentives separate from solar?
4. Is there a waitlist or funding cap on any current programs?
...
For monitoring your battery and solar production together, a home energy monitor like the [Emporia Vue Gen 3](https://www.amazon.com/s?k=emporia+vue+energy+monitor) (around $50-70 on Amazon, and yes the site may earn a commission) gives you real-time data that's essential for participating in demand response programs. You need to know when you're drawing from the battery versus the grid to optimize these incentives properly.
...
- [DSIRE (Database of State Incentives for Renewables & Efficiency)](https://www.dsireusa.org/): Comprehensive national database of state and utility solar incentive programs, updated regularly.
- [EnergySage Solar Marketplace](https://news.energysage.com/): Annual market reports and net metering tracking data across U.S. states.
- [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/): Research on low-income solar programs, battery storage economics, and utility incentive design.
- [SEIA (Solar Energy Industries Association)](https://www.seia.org/): Industry data on installed capacity, net metering policy trends, and state solar rankings.
- [California Public Utilities Commission, NEM 3.0 Decision](https://www.cpuc.ca.gov/): The April 2023 ruling that restructured California net metering export rates.
